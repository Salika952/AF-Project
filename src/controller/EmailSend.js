...
const sendEmail = (to, url, txt) => {
    ...
    const mailOptions = {
        ...
        to: to,
        subject: " Conference Web Shop - 2021",
        html: `
            ...
            <a href=${url} style="background: gold; text-decoration: none; color: white; padding: 10px 20px; margin: 10px 0; display: inline-block;">${txt}</a>
